...
public class DogBoardFactory {
    ...
    public ArrayList<DogBoard> dogList(HashMap<String, String> searchList) {
        String listSQL = "";
        String val = "";
        ...
        for (String key : searchList.keySet()) {
            switch (key) {
                case "title":
                    listSQL = "select bdno,userid,title,contents,views,regdate,file1 from dogboard where title like '%'|| ? ||'%' order by regdate desc";
                    break;
                case "contents":
                    listSQL = "select bdno,userid,title,contents,views,regdate,file1 from dogboard where contents like '%'|| ? ||'%' order by regdate desc";
                    break;
                case "userid":
                    listSQL = "select bdno,userid,title,contents,views,regdate,file1 from dogboard where userid like '%'|| ? ||'%' order by regdate desc";
                    break;
                case "selected":
                    listSQL = "select bdno,userid,title,contents,views,regdate,file1 from dogboard order by regdate desc";
                    break;
            }
