...
<%
    //uid라는 세션객체가 존재하면 Loginok.jsp로 강제로 페이지 전환함
    String uid =(String)session.getAttribute("uid");
    if(uid !=null) response.sendRedirect("loginok.jsp");
...
<div style="margin: 55px 0 20px 0">
    ...
    <small class="text-muted">회원가입을 위해서 아래 사이트 이용약관 &middot; 개인정보 수집 및 이용에 대한 안내를 읽고 동의해 주세요</small>
        ...
        <textarea wrap="hard" rows="10" class="form-control">제1조(목적)
...
<script>
    ...
    $(function() { /*함수실행 -> 조인btn에서 클릭이 발생되면 agreehtml로 이동해라*/
        $('#joinbtn').on('click', function(e) {location.href='agree.jsp';});
    });
    $(function() { /*함수실행 -> 조인btn에서 클릭이 발생되면 어그리html로 이동해라*/
        $('#agreebtn').on('click', function(e) {location.href='checkme1.jsp';});
    });
