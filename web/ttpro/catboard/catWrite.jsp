...
<div class="container">
    ...
    <div class="main">
        <div class="row">
            ...
            <div class="col-3">
                <button type="button" class="btn btn-success" onclick="location.href='dogList.jsp'" style="margin:40px 0 15px 110px; ">
        ...
        <div class="row" style="margin: 10px 30px 20px 50px">
            <form class="card card-body bg-light" name="rbfrm" action="procCatWrite.jsp" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-12 text-center"
                        ...
                        <button type="submit" class="btn btn-primary" id="writebtn"><i class="fa fa-check"> 입력완료</i></button>
