        ...
        <div class="menubar">
             <div class="row" style="margin: 0 0 30px 65px">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<%=baseurl%>/catboard/catList.jsp" id="parcel">분양</a>
                        <ul>
                            <li><a class="nav-link" href="<%=baseurl%>/catboard/catList.jsp">Cat's</a></li>
                            <li><a class="nav-link" href="<%=baseurl%>/dogboard/dogList.jsp">Dog's</a></li>
                            <li><a class="nav-link" href="<%=baseurl%>/reviewboard/revList.jsp">분양후기</a></li>
                        </ul>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="<%=baseurl%>/freeboard/fList.jsp" id="list">게시판</a>
                        <ul>
                            <li><a class="nav-link" href="<%=baseurl%>/freeboard/fList.jsp">자유게시판</a></li>
                            <li><a class="nav-link" href="<%=baseurl%>/qnaboard/QnA.jsp">자주하는질문</a></li>
                            <li><a class="nav-link" href="<%=baseurl%>/qnaboard/qList.jsp">QnA</a></li>
                        </ul>
                    </li>
