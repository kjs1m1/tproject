...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="row" style="margin: 10px 30px 20px 50px">
            <form class="card card-body bg-light" name="writefrm" action="procRevWrite.jsp" method="post" enctype="multipart/form-data" id="writefrm">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" id="wtitle" name="wtitle" class="form-control col-9">
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-2 text-right" for="wcontents">본문내용</label>
                    <textarea rows="20" type="text" id="wcontents" name="wcontents"
