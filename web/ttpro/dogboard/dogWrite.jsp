...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="row" style="margin: 10px 30px 20px 50px">
            <form class="card card-body bg-light" name="rbfrm" action="procDogWrite.jsp" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-12 text-center"
                        ...
                        <button type="submit" class="btn btn-primary" id="okbtn"><i class="fa fa-check"> 입력완료</i></button>
